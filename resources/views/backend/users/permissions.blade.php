...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            @endcomponent
            <!-- end page title -->
         @include('backend.users.partials._permission_form')
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#mainForm', function(event) {
                ...
                $.ajax({
                    ...
                    url: isUpdate ? "{{ route('permissions.update') }}" :
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.data) {
                        ...
                        var url = "{{ route('permissions.index') }}" + "?id=" + data.id;
        ...
        $('#authorizationNav, #permissionsLink').addClass('active');
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            url: "{{ route('permissions.multi.delete') }}",
                            type: 'POST',
                            dataType: 'json',
                            data: {
                                ids: ids_array
