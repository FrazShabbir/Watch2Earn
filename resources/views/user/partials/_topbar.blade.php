            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{asset(fromSettings('logo')??'frontend/img/PLOT XPERTS - LOGO/PLOTXPERTS-LOGO-01.png')}}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset(fromSettings('logo')??'frontend/img/PLOT XPERTS - LOGO/PLOTXPERTS-LOGO-01.png')}}" alt="" height="17">
                        </span>
                    </a>

                    <a href="index.html" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{asset('frontend/img/PLOT XPERTS - LOGO/PLOTXPERTS-LOGO-01.png')}}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset('frontend/img/PLOT XPERTS - LOGO/PLOTXPERTS-LOGO-01.png')}}" alt="" height="17">
                        </span>
                    </a>
                </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="index.html" class="btn btn-soft-primary btn-sm rounded-pill">how to
                                    setup <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="index.html" class="btn btn-soft-primary btn-sm rounded-pill">buttons <i
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                {{-- <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text d-none">Founder</span> --}}
                            </span>
                        </span>
                    </button>
