...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            @endcomponent
            <!-- end page title -->
            @include('backend.package.partials._form')
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#mainForm', function(event) {
                ...
                $.ajax({
                    ...
                    url: isUpdate ? "{{ route('packages.update') }}" :
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.data) {
                        ...
                        var url = "{{ route('packages.index') }}" + "?id=" + data.id;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            url: "{{ route('packages.multi.delete') }}",
                            type: 'POST',
                            dataType: 'json',
                            data: {
                                ids: ids_array
        ...
        $('.table-bordered tbody').on('change', 'input.changeStatus', function() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "{{ route('packages.change.status') }}",
                data: formData,
                dataType: 'json',
        ...
        $('.btn-add').click(function () {
            ...
            clone.find('input').val(''); // Clear input value in the cloned element
            clone.find('.btn-add').remove(); // Remove the add button from the cloned element
